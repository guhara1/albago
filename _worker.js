// Cloudflare Worker — handles all requests
// /api/inquiry → Telegram notification
// 그 외 → 정적 파일 (env.ASSETS)
//
// 이 파일은 Cloudflare Pages 와 Workers (Static Assets) 양쪽에서 동작합니다.
//
...
async function handleInquiry(request, env) {
  ...
  const required = ["companyName", "managerName", "managerPhone", "tier"];
